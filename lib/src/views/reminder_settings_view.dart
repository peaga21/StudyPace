...
import '../services/pomodoro_scheduler.dart';
...
class _ReminderSettingsViewState extends State<ReminderSettingsView> {
  ...
  Future<void> _scheduleGoalReminders() async {
    ...
    final goals = controller.goals.where((goal) => !goal.isCompleted).toList();
                    ...
                    if (_goalRemindersEnabled) ...[
                      ...
                      Consumer<GoalController>(
                        builder: (context, controller, child) {
                          final pendingGoals = controller.goals.where((goal) => !goal.isCompleted).length;
